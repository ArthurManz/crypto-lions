<template>
  <svg version="1.1" id="Lion" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
       width="100%" height="150px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
  <path id="Mane" :fill="hairColor" d="M252.4,492.1c-2.8-2.5-10.2-7.7-16.5-11.6c-13.9-8.5-22-16.2-25.8-24.5l-2.7-6.1l-3.3,5
  ...
  <g id="Face" :fill="skinColor">
    <g>
      <g>
        <g>
          <path d="M253,434c-1.7-2.7-4.4-7.8-5.9-11.5c-1.5-3.6-3-6.8-3.4-7.1c-1-1-4.7,7.4-5.4,12.3
  ...
  <g id="OuterEars" :fill="skinColor">
    <path id="RightOuterEar" d="M422.1,167.4c-2.8-5.8-5.1-10.7-5.1-10.8c0-0.2,2.2-1.7,4.9-3.4
    ...
    <path id="LeftOuterEar" d="M77.2,174c-15.2-10.2-24.9-26.4-28.3-47.5c-1.5-9.7-0.6-32.8,1.6-41.6
  ...
  <g id="BeardAndHeadMark" :fill="chinColor">
    <path id="Beard" d="M253,434c-1.7-2.7-4.4-7.8-5.9-11.5c-1.5-3.6-3-6.8-3.4-7.1c-1-1-4.7,7.4-5.4,12.3
    ...
    <path id="Mark" d="M250.6,183l-5-31l4.9-10c2.7-5.5,5.2-10,5.5-10c0.3,0,2.8,4.5,5.5,10l4.9,10l-5,31
      c-2.7,17-5.1,31-5.4,31C255.7,214,253.3,200,250.6,183z"/>
  </g>
  <g id="Eyes" :fill="eyesColor">
    <g id="LeftEye">
      <g>
        <g>
          <g>
            <path d="M198.5,228.6c-3,2.2-5,2.9-9.9,3.2c-5.6,0.3-6.5,0.1-10.4-2.8c-9.5-6.9-12.5-21.7-6.8-33.3
    ...
    <g id="RightEye">
      <g>
        <g>
          <g>
            <path d="M334.5,228.6c8.8-6.8,11.6-21.7,6.1-32.9c-3.8-7.9-8.2-11-16-11.5c-5.6-0.3-6.5-0.1-10.4,2.8
  ...
  <g id="InnerEars" :fill="eyesColor">
    <path id="LeftInnerEar" d="M101.9,146c7.9-12.7,15.6-22.3,26.6-33l8.7-8.5l-4.3-3.7c-11.5-9.9-32.4-16-44-12.8
      c-13,3.6-19.1,31.4-11,50.3c3,6.9,12.2,16,17.8,17.7C95.7,156,98.6,151.5,101.9,146z"/>
    <path id="RightInnerEar" d="M427.8,147.6c8-8.7,11.5-22.3,9.4-36.2c-2-12.6-6.2-20.2-12.9-23c-10.2-4.4-36.5,3-46.2,13
      l-3.2,3.3l7.7,7.4c11.7,11.3,20.8,23.1,31.8,41.2l1.7,2.7l3.7-1.9C421.9,153,425.5,150.1,427.8,147.6z"/>
  </g>
  <g id="Nose" :fill="noseColor">
    <g>
      <path d="M346.6,337.3c-0.2-0.2-3.4,1.9-7.1,4.7c-22.7,17.2-46.1,19.7-65.1,7.1c-11.6-7.8-10.5-4.3-10.2-31.1l0.3-23.4
  ...
  <g id="Mouth" :fill="eyesColor">
    <g>
      <path d="M342.2,340.2c-4.6,4.4-15.8,11.1-23.1,13.9c-15.5,5.8-31.5,4.2-45.1-4.8c-10.9-7.1-10-4.3-10-31.3v-23.7
  ...
  export default {
    ...
    props: {
      colors: {
        type: Array,
        default () {
          return ['#3e4347', '#906b51', '#b0905b', '#ebc368', '#fefefe']
        }
      }
    },
    computed: {
      eyesColor () { return this.colors[0] },
      hairColor () { return this.colors[1] },
      noseColor () { return this.colors[2] },
      skinColor () { return this.colors[3] },
      chinColor () { return this.colors[4] }
    }
  }
</script>
